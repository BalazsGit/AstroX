...
public class Props {
    ...
    public static final Prop<String> siteNodeAddress = new Prop<>("site.nodeAddress", "https://wallet.signum-alliance.org:8125/");
    ...
    public static final Prop<String> siteExplorerURL = new Prop<>("site.explorer", "https://explorer.signumcoin.network/");
    public static final Prop<String> siteFaucetURL = new Prop<>("site.faucet", "http://faucet.signum-alliance.org/");
    */
    ...
    public static final Prop<String> lightThemeAccentColor = new Prop<>("lightThemeAccentColor", "default");
    public static final Prop<String> darkThemeAccentColor = new Prop<>("darkThemeAccentColor", "default");
